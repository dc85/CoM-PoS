...
//define('FPDF_FONTPATH','../fpdf/font/src/');
...
class PDF_Label extends FPDF {
	...
	function Add_Label($text) {
		...
		$this->MultiCell($this->_Width, $this->_Line_Height, $text[0],0,'C',false);
		$this->SetFont('Arial','',9);
		$this->SetXY($_PosX, $_PosY+5);
		$this->MultiCell($this->_Width, $this->_Line_Height, $text[1],0,'C',false);
		$this->SetXY($_PosX, $_PosY+10);
		$this->MultiCell($this->_Width, $this->_Line_Height, $text[2],0,'C',false);
	}
