...
class PDF extends FPDF
{
	...
	function buildQuery() {
		...
		if($this->connection) {
			...
			$cust_sql = "SELECT tblPCHire.*,cFirstN,".
				...
				"cpType5,cPhone5 ".
				"FROM pos.tblPCHire,pos.tblCustomer ".
				"INNER JOIN pos.tblProvince ON tblCustomer.cProvB=tblProvince.pID ".
			...
			if($cont = mysql_query($cont_sql,$this->connection)) {
				$this->painter = mysql_fetch_assoc($cont);
			}
			if($cust = mysql_query($cust_sql,$this->connection)) {
	...
	function Middle() {
		...
		$this->Cell(90,4,$this->painter['cLastN'].", ".$this->painter['cFirstN']." - ".$this->painter['cCoName'],0,0,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->customer['cLastN'].", ".$this->customer['cFirstN']." - ".$this->customer['cCoName'],0,1,'C');
		
		$this->Cell(90,4,$this->painter['cUnitB']." ".$this->painter['cAdrBus'].", ".$this->painter['cProvB'],0,0,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->customer['cUnitB'].", ".$this->customer['cAdrBus'].", ".$this->customer['cProvB'],0,1,'C');
		
		$this->Cell(90,4,$this->painter['cZipB'],0,0,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->customer['cZipB'],0,1,'C');
		
		$this->Cell(90,4,$this->findPhone($this->painter['cpType1'])." ".$this->painter['cPhone1'],0,0,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->findPhone($this->customer['cpType1'])." ".$this->customer['cPhone1'],0,0,'C');
		
		$this->Cell(90,4,$this->findPhone($this->painter['cpType2'])." ".$this->painter['cPhone2'],0,1,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->findPhone($this->customer['cpType2'])." ".$this->customer['cPhone2'],0,1,'C');
		
		$this->Cell(90,4,$this->findPhone($this->painter['cpType3'])." ".$this->painter['cPhone3'],0,1,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->findPhone($this->customer['cpType3'])." ".$this->customer['cPhone3'],0,1,'C');
		
		$this->Cell(90,4,$this->findPhone($this->painter['cpType4'])." ".$this->painter['cPhone4'],0,1,'C');
		$this->SetX(110);
		$this->Cell(90,4,$this->findPhone($this->customer['cpType4'])." ".$this->customer['cPhone4'],0,1,'C');
		
		$this->Cell(90,4,$this->findPhone($this->painter['cpType5'])." ".$this->painter['cPhone5'],0,1,'C');
		$this->SetX(110);
		...
		$this->SetTextColor(0,0,255);
		$this->Cell(90,6,"Sepcialization",0,0,'L');
		$this->SetX(110);
		...
		if($this->painter['cE1'] != "0") {
			$this->Cell(90,4,"[ Y ] Interior",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Interior",0,0,'L');
		}
		$this->SetX(110);
		...
		if($this->painter['cE2'] != "0") {
			$this->Cell(90,4,"[ Y ] Exterior",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Exterior",0,0,'L');
		}
		$this->SetX(110);
		...
		if($this->painter['cE3'] != "0") {
			$this->Cell(90,4,"[ Y ] Residential",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Residential",0,0,'L');
		}
		$this->SetX(110);
		...
		if($this->painter['cE4'] != "0") {
			$this->Cell(90,4,"[ Y ] Commercial",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Commercial",0,0,'L');
		}
		$this->SetX(110);
		...
		if($this->painter['cE5'] != "0") {
			$this->Cell(90,4,"[ Y ] Stain Work",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Stain Work",0,0,'L');
		}
		$this->SetX(110);
		...
		if($this->painter['cE6'] != "0") {
			$this->Cell(90,4,"[ Y ] Deck & Fence",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Deck & Fence",0,0,'L');
		}
		$this->SetX(110);
		if($this->customer['cE6'] != "0") {
			$this->Cell(90,4,"[ Y ] Deck & Fence",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Deck & Fence",0,1,'L');
		}
		
		if($this->painter['cE7'] != "0") {
			$this->Cell(90,4,"[ Y ] Drywall & Taping",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Drywall & Taping",0,0,'L');
		}
		$this->SetX(110);
		if($this->customer['cE7'] != "0") {
			$this->Cell(90,4,"[ Y ] Drywall & Taping",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Drywall & Taping",0,1,'L');
		}
		
		if($this->painter['cE8'] != "0") {
			$this->Cell(90,4,"[ Y ] Spraying",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Spraying",0,0,'L');
		}
		$this->SetX(110);
		if($this->customer['cE8'] != "0") {
			$this->Cell(90,4,"[ Y ] Spraying",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Spraying",0,1,'L');
		}
		
		if($this->painter['cE9'] != "0") {
			$this->Cell(90,4,"[ Y ] Faux Finish",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Faux Finish",0,0,'L');
		}
		$this->SetX(110);
		if($this->customer['cE9'] != "0") {
			$this->Cell(90,4,"[ Y ] Faux Finish",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Faux Finish",0,1,'L');
		}
		
		if($this->painter['cE10'] != "0") {
			$this->Cell(90,4,"[ Y ] Wall Paper",0,0,'L');
		} else {
			$this->Cell(90,4,"[ N ] Wall Paper",0,0,'L');
		}
		$this->SetX(110);
		if($this->customer['cE10'] != "0") {
			$this->Cell(90,4,"[ Y ] Wall Paper",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Wall Paper",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE11'] != "0") {
			$this->Cell(90,4,"[ Y ] Garage",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Garage",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE12'] != "0") {
			$this->Cell(90,4,"[ Y ] Basement",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Basement",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE13'] != "0") {
			$this->Cell(90,4,"[ Y ] 1st Floor",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] 1st Floor",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE14'] != "0") {
			$this->Cell(90,4,"[ Y ] 2nd Floor",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] 2nd Floor",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE15'] != "0") {
			$this->Cell(90,4,"[ Y ] 3rd Floor",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] 3rd Floor",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE16'] != "0") {
			$this->Cell(90,4,"[ Y ] Entire House",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Entire House",0,1,'L');
		}
		
		$this->Cell(90,4,"",0,0,'L');
		$this->SetX(110);
		if($this->customer['cE17'] != "0") {
			$this->Cell(90,4,"[ Y ] Trim",0,1,'L');
		} else {
			$this->Cell(90,4,"[ N ] Trim",0,1,'L');
		}
		...
		$this->Cell(90,4,"Colours of Maple has Expert Colour Consultants to Assist with Colour Selections.",0,1,'L');
	}
